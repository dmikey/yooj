...
"$1\r").replace(/\t=(.*?)%>/g,"',$1,'").split("\t").join("');").split("%>").join("p.push('").split("\r").join("\\'")+"');return p.join('');")};e.a=a},function(e){e.a=function(c,d){var b={},a;for(a in c)b[a]=c[a];for(a in d)b[a]=d[a],"function"===typeof c[a]&&(b[a].l=c[a]);return b}},function(e,c,d){c=d(1);e.a=new c({tag:"div",init:function(){this.node=document.createElement(this.tag)},render:function(){this.hasComponents()?this.renderComponents():this.renderContent();this.notify("rendered",{})},renderContent:function(){if(!this.template&&
this.content)this.node.innerHTML=this.content;else{var b=this.renderTemplate();this.node.innerHTML=b}},renderComponents:function(){for(var b=0;b<this.components.length;b++)this.components[b].render&&(this.components[b].render(),this.components[b].attach(this.node))},attach:function(b){b.appendChild(this.node);this.wireEvents();this.notify("attached",{})},detach:function(){this.wireEvents(!0);this.node.parentNode.removeChild(this.node)},wireEvents:function(b){if(this.b&&"object"===typeof this.b&&!1===
this.b instanceof Array)for(var a in this.b)this.b.hasOwnProperty(a)&&(b?this.node.removeEventListener(a,this.event,!1):this.node.addEventListener(a,this.b[a]))}})},function(e,c,d){c=d(1);e.a=new c({name:"store",viewstate:{},collection:[],reducers:[],reducer:function(b){this.j.push(function(a,c){return b.call(this,{viewstate:a,collection:c})})},reduce:function(b){for(var a,c=0;c<this.reducers.length;c++)"undefined"===typeof a?(b.viewstate=b.viewstate||{},b.collection=b.collection||[],a=this.reducers[c].call(this,
b.viewstate,b.collection)):a=this.reducers[c].call(this,a.viewstate,a.collection);this.mix(a)},update:function(b){0<this.reducers.length?this.reduce(b):this.mix(b);this.notify("updated",this)}})}])}if("object"===typeof exports&&"object"===typeof module)module.a=f();else if("function"===typeof define&&define.f)define([],f);else{var g=f(),h;for(h in g)("object"===typeof exports?exports:this)[h]=g[h]};
